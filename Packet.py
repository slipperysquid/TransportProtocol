...
class Packet():
    ...
    def __init__(self,sender_IP,sender_port, dest_IP,dest_port ,sequence, data:bytes,ack, recvw = 131200,syn = False,fin=False,is_ack=False): #all inputs are strings
